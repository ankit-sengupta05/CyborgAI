...
class GraphBuildScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Column(children: [
        MFTopBar(
          currentStep: 1, stepName: 'Graph Build', status: 'Ready',
  ...
  Widget _graphPanel(BuildContext context, AppProvider p) {
    return Container(
      ...
      child: GraphView(
        ...
        onRefresh: () => p.addLog('Graph refreshed: ${p.graphData.nodes.length} nodes, ${p.graphData.edges.length} edges'),
      ),
    );
  }
    ...
    return Container(
      ...
      child: SingleChildScrollView(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          MFSectionCard(
            number: '01', title: 'Ontology Generation',
          ...
          MFSectionCard(
            number: '02', title: 'GraphRAG Build',
            ...
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              const Text(
                ...
                style: TextStyle(fontSize: 12, color: MFColors.textSecond, height: 1.5)),
              if (p.buildStatus['graphrag'] == 'complete' || p.buildStatus['buildComplete'] != 'pending') ...[
                const SizedBox(height: 16),
                Row(children: [
                  Expanded(child: MFMetricBox(value: '${p.entityNodes}', label: 'ENTITY NODES')),
                  Expanded(child: MFMetricBox(value: '${p.relationEdges}', label: 'RELATION EDGES')),
                  Expanded(child: MFMetricBox(value: '${p.schemaTypes}', label: 'SCHEMA TYPES')),
                ]),
          ...
          MFSectionCard(
            number: '03', title: 'Build Complete',
            ...
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              const SizedBox(height: 10),
              const Text('Graph build is complete. Proceed to the next step for environment setup.',
                style: TextStyle(fontSize: 12, color: MFColors.textSecond, height: 1.5)),
              if (p.buildStatus['buildComplete'] == 'in_progress') ...[
                ...
                SizedBox(
                  ...
                  child: ElevatedButton(
                    ...
                    child: const Text('Go to Env Setup →', style: TextStyle(fontSize: 14)),
                  ),
                ),
              ],
            ]),
  ...
  Widget _tagSection(String title, List<String> tags) => Column(
    crossAxisAlignment: CrossAxisAlignment.start, children: [
      Text(title, style: const TextStyle(fontSize: 9, color: MFColors.textMuted, letterSpacing: 0.8, fontWeight: FontWeight.w600)),
