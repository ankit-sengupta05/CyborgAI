...
class EnvSetupScreen extends StatefulWidget {
  ...
  @override
  State<EnvSetupScreen> createState() => _EnvSetupScreenState();
}
...
class _EnvSetupScreenState extends State<EnvSetupScreen> {
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        MFSectionCard(
          ...
          child:
            ...
            const Text(
                'Create a simulation instance and fetch simulation world parameter templates',
                style: TextStyle(
        ...
        MFSectionCard(
          ...
          child:
            ...
            const SizedBox(height: 8),
            const Text(
                'Based on context and related topics from real-world seeds, generate complete Agent profiles for each entity',
                style: TextStyle(
                    fontSize: 12, color: MFColors.textSecond, height: 1.5)),
            if (env['agentProfiles'] == 'completed') ...[
              ...
              Row(children: [
                Expanded(
                    child: MFMetricBox(
                        value: '${p.totalAgents}', label: 'CURRENT AGENTS')),
                Expanded(
                    child: MFMetricBox(
                        value: '${p.expectedTotal}', label: 'EXPECTED TOTAL')),
                Expanded(
                    child: MFMetricBox(
                        value: '${p.relatedTopics}', label: 'RELATED TOPICS')),
              ]),
              const SizedBox(height: 16),
              ...
              if (p.agents.isEmpty)
                ...
                SizedBox(
                  ...
                  child: ListView(
                      ...
                      children: p.agents
                          .take(6)
                          .map((a) => _AgentCard(agent: a))
                          .toList()),
                ),
            ] else if (env['agentProfiles'] == 'processing') ...[
              const SizedBox(height: 12),
              const _ProcessingBar(
                  label: 'Generating agent profiles with LLM...'),
            ],
          ]),
        ),
        ...
        MFSectionCard(
          ...
          child:
            ...
            const SizedBox(height: 8),
            const Text(
                'LLM generates dual-platform simulation config parameters based on simulation requirements and Agent profiles',
                style: TextStyle(
                    fontSize: 12, color: MFColors.textSecond, height: 1.5)),
        ...
        MFSectionCard(
          ...
          child:
            ...
            const SizedBox(height: 8),
            const Text(
                'Orchestrate the initial activation sequence based on narrative direction and Agent profiles',
                style: TextStyle(
                    fontSize: 12, color: MFColors.textSecond, height: 1.5)),
        ...
        MFSectionCard(
          ...
          child: Column(children: [
            ...
            const SizedBox(height: 8),
            const Text(
                'Simulation environment is ready. You can start running the simulation.',
                style: TextStyle(
                    fontSize: 12, color: MFColors.textSecond, height: 1.5)),
            if (env['ready'] == 'in_progress') ...[
              ...
              Container(
                ...
                child: Column(
                    ...
                    children: [
                      ...
                      const Text(
                          'Auto-calculated based on time config (72 hours / 60 min per round)',
                          style: TextStyle(
                              fontSize: 11, color: MFColors.accentGreen)),
                      const SizedBox(height: 12),
                      Row(children: [
                        Text('$_customRounds',
                        ...
                        const Text('rounds',
                            style: TextStyle(
                                color: MFColors.textSecond, fontSize: 13)),
                        ...
                        Container(
                          ...
                          child: Row(mainAxisSize: MainAxisSize.min, children: [
                            const Icon(Icons.access_time,
                                size: 10, color: MFColors.textMuted),
                        ...
                        Flexible(
                          child: ConstrainedBox(
                            ...
                            child: Slider(
                              ...
                              onChanged: (v) =>
                                  setState(() => _customRounds = v.round()),
                            ),
                          ),
                        ),
                      ]),
                      const SizedBox(height: 8),
                      const Text(
                          'Need to adjust rounds? Use the slider above →',
                          style: TextStyle(
              ...
              Row(children: [
                Expanded(
                  ...
                  onPressed: () =>
                      context.read<AppProvider>().setStep(AppStep.graphBuild),
        ...
        children: data.entries
            .map((e) => Container(
                  ...
                  decoration: BoxDecoration(
                      border: Border(
                          bottom: BorderSide(
                              color: MFColors.border.withOpacity(0.5)))),
                  child: Row(children: [
                    SizedBox(
                        width: 130,
                        child: Text(e.key,
  ...
  Widget _configTile(String label, String value) => Expanded(
          child: Column(children: [
        Text(value,
        ...
        children: rows
            .map((r) => Container(
                  ...
                  decoration: const BoxDecoration(
                      border: Border(
                          bottom: BorderSide(color: MFColors.borderLight))),
                  child: Row(children: [
                    SizedBox(
                        width: 110,
                        child: Text(r.$1,
    ...
    return Container(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        Text(agent.description,
            style: const TextStyle(
                fontSize: 10, color: MFColors.textSecond, height: 1.3),
            maxLines: 2,
            overflow: TextOverflow.ellipsis),
        const SizedBox(height: 6),
        Wrap(
            ...
            children: agent.topics
                ...
                .map((t) => Container(
                      ...
                      child: Text(t,
                          style: const TextStyle(
                              fontSize: 8, color: MFColors.accentBlue)),
                    ))
                .toList()),
      ]),
    );
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Row(children: [
          Container(
              ...
              height: 20,
              decoration: BoxDecoration(
                  color: MFColors.accentOrange.withOpacity(0.2),
                  shape: BoxShape.circle),
              child: const Icon(Icons.navigation,
                  size: 12, color: MFColors.accentOrange)),
        ...
        const Text(
            ...
            style: TextStyle(
                fontSize: 12, height: 1.6, color: MFColors.textPrimary)),
        const SizedBox(height: 14),
