      ...
      Expanded(
        ...
        child: Container(
          ...
          child: p.reportContent.isEmpty
              ? Center(
                  child: p.reportGenerating
                      ? const Column(mainAxisSize: MainAxisSize.min, children: [
                          CircularProgressIndicator(
                              strokeWidth: 2, color: MFColors.accentGreen),
                          SizedBox(height: 16),
                          Text('Generating report with ReportAgent...',
                              style: TextStyle(color: MFColors.textSecond)),
                        ])
              ...
              : Markdown(
                  ...
                  styleSheet: MarkdownStyleSheet(
                    ...
                    h3: const TextStyle(
                        ...
                        color: MFColors.textPrimary),
                    p: const TextStyle(
                        fontSize: 13, height: 1.7, color: MFColors.textPrimary),
                    listBullet: const TextStyle(
                        fontSize: 13, color: MFColors.textSecond),
...
class _WorkbenchTrace extends StatelessWidget {
    ...
    return Column(children: [
      ...
      Container(
        ...
        child: Row(children: [
          ...
          if (done) ...[
            _pill(
                'ELAPSED ${(sections.length * 2 + 6)}m ${(sections.length * 3 + 50)}s'),
            ...
            const SizedBox(
                ...
                child: CircularProgressIndicator(
                    strokeWidth: 1.5, color: MFColors.accentOrange)),
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          if (sections.isNotEmpty)
            ...
            ...[
              ...
              'Complete'
            ].asMap().entries.map((e) => _SectionRow(
          ...
          if (done) ...[
            ...
            SizedBox(
                ...
                child: ElevatedButton(
                  onPressed: () =>
                      context.read<AppProvider>().setStep(AppStep.interaction),
                  ...
                  child: const Text('Go to Interaction →',
                      style:
          ...
          _traceSection('REPORT STARTED', [
            ...
            _traceKV(
                'Requirement',
                p.reportRequirement.isNotEmpty
                    ? p.reportRequirement
          ...
          if (sections.isNotEmpty || done) ...[
            ...
            _traceSection('PLAN COMPLETE', [
              ...
              Container(
                ...
                child: Text(
                    '${sections.isEmpty ? 3 : sections.length} sections planned',
                    style: const TextStyle(
  ...
  Widget _pill(String label) => Container(
      ...
      decoration: BoxDecoration(
          ...
          borderRadius: BorderRadius.circular(4)),
      child: Text(label,
          style: const TextStyle(fontSize: 9, color: MFColors.textSecond)));
    ...
    return Padding(
      ...
      child: Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Container(
            ...
            decoration: const BoxDecoration(
                color: MFColors.textMuted, shape: BoxShape.circle)),
        Expanded(
            child:
  ...
  Widget _tracePill(String label, Color bg) => Container(
      ...
      child: Text(label,
          style: const TextStyle(fontSize: 11, color: MFColors.textPrimary)));
}
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        border: Border.all(
            color: isDone
                ? MFColors.accentGreen.withOpacity(0.3)
                : MFColors.border),
        borderRadius: BorderRadius.circular(6),
        ...
        Expanded(
            child: Text(section.title,
                style: TextStyle(
                    fontSize: 12,
                    color:
                        isDone ? MFColors.textPrimary : MFColors.textSecond))),
      ]),
    );
  }
}
