...
Color _nc(String type) {
  ...
  if (t == 'governmentagency' || t == 'government')
...
class _GVS extends State<GraphView> with TickerProviderStateMixin {
  ...
  double _nodeR(_N n) =>
      (7.0 + math.sqrt(n.degree.toDouble()) * 2.5).clamp(7.0, 20.0);
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(builder: (ctx, c) {
      ...
      final sel =
          _sel != null ? _nodes.where((n) => n.id == _sel).firstOrNull : null;
      ...
      return Stack(children: [
        ...
        Listener(
          onPointerSignal: (e) {
            if (e is PointerScrollEvent)
              setState(() => _scale =
                  (_scale * (e.scrollDelta.dy > 0 ? 0.88 : 1.12))
                      .clamp(0.06, 12.0));
          },
        ...
        // ── Edge label toggle ────────────────────────────────────────────────
        Positioned(
            top: 40, right: 8, child: _Tog(value: widget.showEdgeLabels)),
...
class _P extends CustomPainter {
  ...
  double _nr(_N n) =>
      ((7.0 + math.sqrt(n.degree.toDouble()) * 2.5).clamp(7.0, 20.0) * scale)
          .clamp(4.0, 24.0);
      ...
      if (hasFocus && !isHl) {
        canvas.drawCircle(
            ...
            Paint()
              ...
              ..style = PaintingStyle.fill);
        if (scale > 0.35) {
          final lbl = node.label.length > 12
  ...
  Offset _ctrl(Offset p1, Offset p2) {
    ...
    final hash =
        (p1.dx * 7 + p1.dy * 13 + p2.dx * 17 + p2.dy * 19).toInt().abs();
  ...
  void _drawCurvedEdge(
      Canvas canvas, Offset p1, Offset p2, Paint paint, Color? arrowColor) {
    final ctrl = _ctrl(p1, p2);
    final path = Path()
      ..moveTo(p1.dx, p1.dy)
...
class _Det extends StatelessWidget {
          ...
          Container(
              ...
              child: Row(children: [
                ...
                Container(
                    ...
                    decoration: BoxDecoration(
                        color: col, borderRadius: BorderRadius.circular(5)),
                    ...
                    if (conn.isNotEmpty) ...[
                      ...
                      Wrap(
                          ...
                          children: conn.take(6).map((c) {
                            final cc = _nc(c.type);
                            final lbl = c.label.length > 13
                                ? '${c.label.substring(0, 11)}...'
                                : c.label;
                            return Container(
                                ...
                                decoration: BoxDecoration(
                                    ...
                                    border:
                                        Border.all(color: cc.withOpacity(0.35)),
                                    borderRadius: BorderRadius.circular(4)),
                                child: Text(lbl,
                                    style:
                                        TextStyle(fontSize: 9.5, color: cc)));
                          }).toList()),
                    ],
                    const SizedBox(height: 13),
                    const Text('Labels:',
  ...
  Widget _kv(String k, String v,
          {bool bold = false, bool mono = false, bool small = false}) =>
  ...
  Widget _chip(String t, Color c) => Container(
      ...
      child: Text(t,
          style:
              TextStyle(fontSize: 9.5, color: c, fontWeight: FontWeight.w500)));
}
  ...
  Widget build(BuildContext _) => Container(
      ...
      child: Row(mainAxisSize: MainAxisSize.min, children: [
        Container(
            ...
            decoration: BoxDecoration(
                color:
                    value ? const Color(0xFF22C55E) : const Color(0xFFCBD5E1),
            ...
            children: types
                ...
                .map((t) => Row(mainAxisSize: MainAxisSize.min, children: [
                      Container(
                          ...
                          height: 9,
                          decoration: BoxDecoration(
                              color: _nc(t), shape: BoxShape.circle)),
                      const SizedBox(width: 4),
                      Text(t,
                          style: const TextStyle(
                              fontSize: 9.5, color: Color(0xFF111827))),
                    ]))
                .toList()),
      ]));
}
