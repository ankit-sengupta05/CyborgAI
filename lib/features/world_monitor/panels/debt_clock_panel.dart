...
class DebtClockPanel extends StatefulWidget {
  ...
  @override
  State<DebtClockPanel> createState() => _DebtClockPanelState();
}
...
class _DebtClockPanelState extends State<DebtClockPanel> {
  ...
  static const _debtPerSec = {
    'United States': 52000.0,
    'Japan': 12000.0,
    'China': 18000.0,
    'Germany': 4000.0,
    'France': 5000.0,
    'United Kingdom': 5200.0,
    'Italy': 4800.0,
    'India': 6000.0,
    'Canada': 2500.0,
    'Brazil': 3000.0,
  ...
  Widget build(BuildContext context) {
    ...
    return GridPanel(
      ...
      isLive: true,
      onClose: () =>
          context.read<DashboardProvider>().togglePanel(PanelId.debtClock),
      headerActions: [
          ...
          child: SingleChildScrollView(
            ...
            child:
              ...
              Row(children: [
                Expanded(
                    child: _StatTile(
                        label: 'PER SECOND', value: '\$${_fmt(perSec)}')),
                const SizedBox(width: 6),
                Expanded(
                    child: _StatTile(
                        label: 'PER CITIZEN', value: '\$${_fmt(perCit)}')),
                const SizedBox(width: 6),
                Expanded(
                    child: _StatTile(
                        label: 'DEBT/GDP',
              ...
              ClipRRect(
                  ...
                  child: LinearProgressIndicator(
                    ...
                    valueColor: AlwaysStoppedAnimation(ratio > 1.2
                        ? WMColors.accentRed
                        : WMColors.accentOrange),
                    minHeight: 8,
                  )),
              const SizedBox(height: 14),
              const Text('GLOBAL COMPARISON',
                  style: TextStyle(
                      color: WMColors.textSecond,
                      fontSize: 8,
                      letterSpacing: 1.0)),
              ...
              ..._debtBase.entries.map((e) {
                ...
                final secs = (provider.now.hour * 3600 +
                        provider.now.minute * 60 +
                        provider.now.second)
                    .toDouble();
                ...
                return GestureDetector(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      border: Border(
                          bottom: BorderSide(
                              color: WMColors.border.withOpacity(0.3))),
                    ),
                    child: Row(children: [
                      Expanded(
                          child: Text(e.key,
                              style: TextStyle(
                                  color: isSelected
                                      ...
                                      : WMColors.textSecond,
                                  fontSize: 9))),
                      Text('\$${(cur / 1e12).toStringAsFixed(2)}T',
                          style: TextStyle(
                              color: isSelected
                                  ? WMColors.accentGreen
                                  : WMColors.textMuted,
...
class _StatTile extends StatelessWidget {
  ...
  const _StatTile(
      {required this.label,
      required this.value,
      this.color = WMColors.accentOrange});
  @override
  Widget build(BuildContext context) => Container(
        ...
        child: Column(children: [
          Text(label,
              style: const TextStyle(
                  color: WMColors.textMuted, fontSize: 7, letterSpacing: 0.8)),
