...
class WMTheme {
  static ThemeData get dark => ThemeData(
    ...
    textTheme: GoogleFonts.jetBrainsMonoTextTheme(ThemeData.dark().textTheme).copyWith(
      ...
      labelLarge:  TextStyle(color: WMColors.accentGreen, fontSize: 10, letterSpacing: 1.2,
                             fontFamily: GoogleFonts.jetBrainsMono().fontFamily),
      titleMedium: const TextStyle(color: WMColors.textPrimary, fontSize: 11, fontWeight: FontWeight.w700),
    ),
...
extension MapVariantExt on MapVariant {
  String get label {
    switch (this) {
      case MapVariant.world:     return 'WORLD';
      case MapVariant.tech:      return 'TECH';
      case MapVariant.finance:   return 'FINANCE';
      case MapVariant.commodity: return 'COMMODITY';
      case MapVariant.energy:    return 'ENERGY';
      case MapVariant.goodNews:  return 'GOOD NEWS';
    }
  }

  Color get accent {
    switch (this) {
      case MapVariant.world:     return WMColors.accentGreen;
      case MapVariant.tech:      return WMColors.techCyan;
      case MapVariant.finance:   return WMColors.financeGreen;
      case MapVariant.commodity: return WMColors.commodityOrange;
      case MapVariant.energy:    return WMColors.energyPurple;
      case MapVariant.goodNews:  return WMColors.goodNewsGreen;
    }
  }
}
