...
bool get devModeOfflineBypass => Hive.box('cyborg_cache').get('offline_bypass', defaultValue: false);
set devModeOfflineBypass(bool val) => Hive.box('cyborg_cache').put('offline_bypass', val);
    ...
    routes: [
      ...
      ShellRoute(
        ...
        routes: [
          ...
          GoRoute(path: '/chat/:id', builder: (_, s)  => ChatScreen(sessionId: s.pathParameters['id'])),
          GoRoute(path: '/graph',    builder: (_, __) => const KnowledgeGraphScreen()),
          ...
          GoRoute(path: '/codeflow', builder: (_, __) => const CodeFlowScreen()),
          GoRoute(path: '/monitor',  builder: (_, __) => const WorldMonitorScreen()),
          GoRoute(path: '/mirofish', builder: (_, __) => const MiroFishScreen()),
          GoRoute(path: '/devices',  builder: (_, __) => const DeviceManagerScreen()),
